...
const Hero = () => {
  return (
    <section id="home" className="flex flex-col md:flex-row items-center justify-center md:justify-between max-w-6xl mx-auto px-8 md:px-16 lg:px-24 py-20 bg-secondary dark:bg-[#001f3f]">
